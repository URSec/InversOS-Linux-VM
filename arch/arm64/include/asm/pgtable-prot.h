...
#ifdef CONFIG_ARM64_INVERSOS
#define PROT_DEFAULT		(_PROT_DEFAULT | PTE_MAYBE_NG | PTE_USER | PTE_KERNEL)
#define PROT_SECT_DEFAULT	(_PROT_SECT_DEFAULT | PMD_MAYBE_NG | PMD_SECT_USER | PMD_SECT_KERNEL)
#else
